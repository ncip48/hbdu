...
class App extends Component {
  static defaultProps = {
    ...
    panggilan: ["Revina 😡"], //edit untuk panggilan
    tanggal_lahir: "24/04/2004", //untuk edit tanggal lahir doi kau
    nama: "Revvv", //edit untuk nama di ballon, maksimal 5 kata aja xixixi
    warna: [
      "#FF6900",
      "#FCB900",
      "#7BDCB5",
